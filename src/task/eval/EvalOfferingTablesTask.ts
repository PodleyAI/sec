...
import { runOfferingTablesEval } from "../../eval/runOfferingTablesEval";
...
export type EvalOfferingTablesTaskInput = Static<ReturnType<typeof InputSchema>>;
...
export type EvalOfferingTablesTaskOutput = Static<ReturnType<typeof OutputSchema>>;

/**
 * Scores the deterministic SPAC offering/promote table parser against stored
 * rows using on-disk accession docs. Never fetches EDGAR.
 */
export class EvalOfferingTablesTask extends Task<
  EvalOfferingTablesTaskInput,
  EvalOfferingTablesTaskOutput
> {
  static readonly type = "EvalOfferingTablesTask";
  static readonly category = "SEC";
  static readonly title = "Evaluate offering tables";
  ...
  async execute(
    input: EvalOfferingTablesTaskInput,
    ...
    return report as unknown as EvalOfferingTablesTaskOutput;
  }
}
