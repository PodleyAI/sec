...
export async function resetAllDatabases(): Promise<void> {
  ...
  await globalServiceRegistry.get(PERSON_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(PERSON_ENTITY_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(PERSON_ADDRESS_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(PERSON_PHONE_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(PERSON_PREVIOUS_NAMES_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(COMPANY_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(COMPANY_ENTITY_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(COMPANY_ADDRESS_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(COMPANY_PHONE_JUNCTION_REPOSITORY_TOKEN).deleteAll();
  await globalServiceRegistry.get(COMPANY_PREVIOUS_NAMES_REPOSITORY_TOKEN).deleteAll();
