...
**Priced prospectus (424B4)** — the priced-IPO companion to a registration
fixture, exercised by `Form_424.golden.test.ts`. Same primary-doc HTML shape as
the S-1 files (`Form_424.parse()` hands the converter the same body). Filename
`424b4_<cik>_<accession-no-dashes>.htm`.

| File                                   | CIK     | Accession            | Company                    | SIC  | SPAC | Resolves (target sections)                                                                                                                                                                                                                |
| -------------------------------------- | ------- | -------------------- | -------------------------- | ---- | ---- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `424b4_2114227_000121390026048413.htm` | 2114227 | 0001213900-26-048413 | Churchill Capital Corp XII | 6770 | ✅   | The Offering, Underwriting, Use of Proceeds — **priced companion** to `s1_2114227_*` (final deal: 36,000,000 units @ $10.00, Citigroup underwriter). Fee-prepaid under Rule 456(a): **no** inline XBRL / fee exhibit (untagged-body path) |
