...
| `exfee_19617_000183988226028863.htm`   | 19617   | 0001839882-26-028863 | JPMorgan Chase & Co. **424B2** `EX-FILING FEES` exhibit — the pay-as-you-go (Rule 456(b)) narrative shape: 12 facts incl. `ffd:NrrtvMaxAggtOfferingPric` (takedown size), `ffd:FnlPrspctsFlg`, and `ffd:RegnFileNb` tying the prospectus back to its S-3 registration. Pinned by `parseXbrl.golden.test.ts`. |
