...
export const REGISTRATION_ON_EXCHANGE = [
  "8-A12B",
...
export const REGISTRATION_WITHDRAWAL_FORMS = [
...
export const SEC_CORRESPONDENCE = [
...
export const PORTAL = ["CFPORTAL", "CFPORTAL/A", "CFPORTAL-W"] as const;

export const FORM_OTHER = [
  "SD", // Special Disclosure (example: Conflict Minerals Disclosure)
] as const;

export const ALL_FORMS = [
  ...REGISTRATION_FORMS,
  ...REGISTRATION_ON_EXCHANGE,
  ...REGISTRATION_WITHDRAWAL_FORMS,
  ...INSIDER_TRADING,
...
export type RegistrationOnExchange = (typeof REGISTRATION_ON_EXCHANGE)[number];
export type RegistrationWithdrawalForm = (typeof REGISTRATION_WITHDRAWAL_FORMS)[number];
export type InsiderTrading = (typeof INSIDER_TRADING)[number];
export type BeneficialOwnership = (typeof BENEFICIAL_OWNERSHIP)[number];
export type TenderForms = (typeof TENDER_FORMS)[number];
export type ProxyForms = (typeof PROXY_FORMS)[number];
export type CompanyReports = (typeof COMPANY_REPORTS)[number];
export type SecCorrespondence = (typeof SEC_CORRESPONDENCE)[number];
export type ExemptOfferings = (typeof EXEMPT_OFFERINGS)[number];
export type Portal = (typeof PORTAL)[number];
export type FormOther = (typeof FORM_OTHER)[number];
