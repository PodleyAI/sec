...
export const REGISTRATION_STATEMENTS = [
  ...
  ["S-6 POS", "This filing is a post-effective amendment to an S-6 filing."],
  ["S-6EL24", "Registration statements of unit investment trusts with 24f-2 election"],
  [
    "S-8",
  ...
  [
    "497VPSUB",
    "A substitution-related supplement for variable contracts filed pursuant to Securities Act Rule 497(k).",
  ],
  ...
  ["N-4 EL", "Registration statement for separate accounts (unit investment trusts)."],
  ["N-4 EL/A", "This filing is a pre-effective amendment to an N-4 EL filing."],
  ...
  [
    "N14EL24",
    "Electronic post-effective amendment on Form N-14 filed pursuant to Rule 485(b)(1)(iii).",
  ],
  ["N14EL24/A", "Amendment to a previously filed N14EL24."],
  ["N-14 8C", "Registration statement for closed-end investment company."],
  ["N-14 8C/A", "Pre-effective amendment."],
  [
    "N14AE24",
    "Post-effective amendment filed pursuant to Rule 485(b)(1)(iii) on Form N-14 to designate a new effective date for a prior post-effective amendment.",
  ],
  ["N14AE24/A", "Amendment to a previously filed N14AE24."],
  [
    "N14AE24",
    "Post-effective amendment filed pursuant to Rule 485(b)(1)(iii) on Form N-14 to designate a new effective date for a prior N-14 post-effective amendment.",
  ],
  ["N14AE24/A", "Amendment to a previously filed N14AE24."],
  ...
  ["POS EX/A", "Amendment to a previously filed POS EX."],
  ["POS 8C", "Post-effective amendment to a previously filed 8C."],
  ["CB", "Business combination transaction report under Section 12(b)."],
  ["CB/A", "Amendment to a previously filed CB."],
  ["F-X", "Registration statement or amendment under Securities Act Form F-X."],
  ["F-X/A", "Amendment to a previously filed F-X."],
  ["POS AMC", "Post-effective amendment to a previously filed registration statement."],
  [
    "SUPPL",
